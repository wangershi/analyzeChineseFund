...
def analyzeHistoricalValue(ifUseNewIssues = True, ifUseOldIssues = True, ifUseWatchList = False, ifUseAdjustFactorToLatestDay = False, ifPrintFundCode = False, fund_to_specify_date="000934"):
    '''
        Args:
            ...
            fund_to_specify_date: specify a fund to use its trading days as the common trading days to prevent the days poluteed by some funds
    '''
    ...
    for file in D.list_instruments(instruments=instruments, as_list=True):
        ...
        try:
            ...
            df = D.features([file], [
                ...
                ], start_time=firstDay, end_time=lastDay)
            df.columns = [
                'AccumulativeNetAssetValue',
                'GrowthRatio'
                ]
